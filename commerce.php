      ...
      <div class="container">
         <div class="row justify-content-lg-between align-items-center">
            <div class="col-lg-5 me-auto">
               ...
               <a href="https://tegro.money/my/" class="btn btn-primary" target="_blank">Connect Store <i class="fas fa-arrow-right ms-3"></i></a> 
            </div>
               ...
               <ul class="list-unstyled section__desc m-0">
                  <li class="pb-4">
                     <div class="d-flex align-items-center">
                        ...
                        <span class="ms-3 fs-18">Accepting payments in Toncoin with a 1% commission;</span>
                     </div>
                  </li>
                  <li class="pb-4">
                     <div class="d-flex align-items-center">
                        <i class="fa-solid fa-circle-check fs-24 text-primary"></i>
                        <span class="ms-3 fs-18">Invoicing for payment;</span>
                     </div>
                  </li>
                  <li class="pb-4">
                     <div class="d-flex align-items-center">
                        <i class="fa-solid fa-circle-check fs-24 text-primary"></i>
                        <span class="ms-3 fs-18">Adding TON network wallets;</span>
                     </div>
                  </li>
                  <li class="p-0">
                     <div class="d-flex align-items-center">
                        <i class="fa-solid fa-circle-check fs-24 text-primary"></i>
                        <span class="ms-3 fs-18">Easy integration with Telegram bot</span>
                     </div>
                  </li>
               </ul>
            </div>
